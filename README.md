...
A Relational Database Management System is the db software, this manages storage, querying, and updating. SQL is a language used to query the RDBMS.

1. Why do tables need a `primary key`?

The primary key is a unique identifier for each row in a table. Besides being generally useful a primary key is essential to creating a foreign key.
